...
export const Route = createFileRoute("/contact")({
  head: () => ({
    meta: [
      ...
      {
        name: "description",
        content: `Maryame El Khalfi — AI & Software Engineer, available from ${site.availability.startDate} for junior engineering roles. Based in ${site.location}.`,
      },
      { property: "og:title", content: `Contact — ${site.name}` },
      {
        property: "og:description",
        content: "Availability, contact form, contact details, languages and location.",
      },
  ...
  return (
    <SiteShell>
      <PageHeader
        ...
        lead="Looking for a junior engineering role in AI, backend or full-stack development. Based in Rabat, open to remote."
      />
              ...
              <div className="card-surface p-8">
                ...
                <div className="flex flex-col gap-3 sm:flex-row">
                  <a
                    ...
                    className="inline-flex flex-1 items-center justify-center gap-2 rounded-full bg-surface-2 border border-border-strong px-5 py-3 text-sm font-medium text-foreground transition-transform hover:-translate-y-0.5 hover:border-accent hover:text-accent"
                  >
                ...
                <div className="mt-8 grid gap-px overflow-hidden rounded-xl border border-border bg-border">
                  {[
                    ...
                    <a
                      key={c.label}
                      href={c.href}
                      target={c.href.endsWith(".pdf") || c.href.startsWith("http") ? "_blank" : undefined}
                      rel={c.href.endsWith(".pdf") || c.href.startsWith("http") ? "noreferrer noopener" : undefined}
